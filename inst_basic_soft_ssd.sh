...
LOCK_FILE="/root/inst_basic_soft_ssd.lock"
SCRIPT_PATH="/root/inst_basic_soft_ssd.sh"
SERVICE_FILE="/etc/systemd/system/armbian-install.service"
LOG_FILE="/root/inst_basic_soft_ssd.log"
...
if [ ! -f "$SCRIPT_PATH" ]; then
    ...
    curl -fsSL https://raw.githubusercontent.com/KLEIN-Technologies/Armbian/main/inst_basic_soft_ssd.sh -o "$SCRIPT_PATH"
    chmod +x "$SCRIPT_PATH"
fi
