...
LOCK_FILE="/root/deploy_basic.lock"
SCRIPT_PATH="/root/deploy_basic.sh"
SERVICE_FILE="/etc/systemd/system/armbian-install.service"
LOG_FILE="/root/deploy_basic.log"
...
if [ ! -f "$SCRIPT_PATH" ]; then
    ...
    curl -fsSL https://raw.githubusercontent.com/KLEIN-Technologies/Armbian/main/deploy_basic.sh -o "$SCRIPT_PATH"
    chmod +x "$SCRIPT_PATH"
fi
